...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'crawler_post', 'date', self.gf('django.db.models.fields.CharField')(max_length=120, null=True))

    def backwards(self, orm):

        # Changing field 'Post.date'
        db.alter_column(u'crawler_post', 'date', self.gf('django.db.models.fields.CharField')(default='', max_length=120))
    ...
    models = {
        ...
        u'crawler.post': {
            ...
            'date': ('django.db.models.fields.CharField', [], {'max_length': '120', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
